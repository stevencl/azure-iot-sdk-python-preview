...
from azure.iot.iothub.device.auth.base_renewable_token_authentication_provider import (
...
def fake_get_current_time_function():
    with patch(
        "azure.iot.iothub.device.auth.base_renewable_token_authentication_provider.time.time",
...
def fake_timer_object():
    with patch(
        "azure.iot.iothub.device.auth.base_renewable_token_authentication_provider.Timer",
