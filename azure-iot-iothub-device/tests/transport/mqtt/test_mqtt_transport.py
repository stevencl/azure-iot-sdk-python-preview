...
from azure.iot.iothub.device import Message
from azure.iot.iothub.device.transport.mqtt.mqtt_transport import MQTTTransport
from azure.iot.iothub.device.transport import constant
from azure.iot.iothub.device.auth.authentication_provider_factory import from_connection_string
...
def device_transport(authentication_provider):
    with patch("azure.iot.iothub.device.transport.mqtt.mqtt_transport.MQTTProvider"):
