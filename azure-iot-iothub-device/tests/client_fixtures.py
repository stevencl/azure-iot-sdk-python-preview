...
import pytest
from azure.iot.iothub.device.transport.abstract_transport import AbstractTransport
...
def auth_provider(request):
    from azure.iot.iothub.device.auth.authentication_provider_factory import (
