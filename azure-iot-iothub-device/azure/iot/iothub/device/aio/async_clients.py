...
from azure.iot.iothub.device.abstract_clients import (
    AbstractClient,
    AbstractDeviceClient,
    AbstractModuleClient,
)
from azure.iot.iothub.device.common import Message
from azure.iot.iothub.device.transport import constant
from azure.iot.iothub.device.inbox_manager import InboxManager
...
class GenericClient(AbstractClient):
    ...
    async def _enable_feature(self, feature_name):
        ...
        See azure.iot.iothub.device.transport.constant for possible values.
        """
