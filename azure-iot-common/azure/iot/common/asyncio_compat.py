...
def create_task(coro):
    """
    "Best effort" function. If avaialable (Python 3.7+), use asyncio.create_task,
    which is preferred as it is more specific for the goal of immediately scheduling
    a task from a coroutine. If not avaialble, use the more general puprose 
