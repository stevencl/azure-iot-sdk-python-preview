...
class ClientSharedTests(object):
    ...
    async def test_receive_method_enables_methods_only_if_not_already_enabled(
        self, client, transport
    ):
        pass

    @pytest.mark.skip(reason="Not Implemented")
    async def test_receive_method_called_without_method_name_returns_method_call_from_generic_method_inbox(
        self, client, tranposrt
    ):
        pass

    @pytest.mark.skip(reason="Not Implemented")
    async def test_receive_method_called_with_method_name_returns_method_call_from_named_method_inbox(
        self, client, transport
    ):
        pass
