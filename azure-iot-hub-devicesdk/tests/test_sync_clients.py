...
class ClientSharedTests(object):
    ...
    def test_receive_method_enables_methods_only_if_not_already_enabled(self, client, transport):
        pass

    @pytest.mark.skip(reason="Not Implemented")
    def test_receive_method_called_without_method_name_returns_method_call_from_generic_method_inbox(
        self, client, tranposrt
    ):
        pass

    @pytest.mark.skip(reason="Not Implemented")
    def test_receive_method_called_with_method_name_returns_method_call_from_named_method_inbox(
    ...
    def test_receive_method_can_be_called_in_mode(self, mocker, client, block, timeout):
        pass
